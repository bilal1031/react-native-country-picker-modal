...
export declare const CountryPicker: ({ allowFontScaling, countryCode, region, subregion, countryCodes, renderFlagButton: renderButton, renderCountryFilter, filterProps, modalProps, flatListProps, onSelect, withEmoji, withFilter, withCloseButton, withCountryNameButton, withCallingCodeButton, withCurrencyButton, withAlphaFilter, withCallingCode, withCurrency, withFlag, withModal, withFlagButton, disableNativeModal, containerButtonStyle, onClose: handleClose, onOpen: handleOpen, closeButtonImage, closeButtonStyle, closeButtonImageStyle, excludeCountries, placeholder, preferredCountries, visible: isVisible, }: CountryPickerProps) => React.JSX.Element;
export {};
