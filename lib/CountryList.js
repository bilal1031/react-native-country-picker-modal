...
const renderItem = (props) => ({ item: country }) => (react_1.default.createElement(CountryItem, Object.assign({ country }, props)));
...
const CountryList = ({ data, withAlphaFilter = false, withEmoji = true, withFlag = true, withCallingCode = false, withCurrency = false, onSelect, filter, flatListProps, filterFocus, }) => {
    ...
    return (react_1.default.createElement(react_native_1.View, { style: [styles.container, { backgroundColor }] },
        react_1.default.createElement(react_native_1.FlatList, Object.assign({ ref: flatListRef, testID: 'list-countries', keyboardShouldPersistTaps: 'handled', automaticallyAdjustContentInsets: false, scrollEventThrottle: 1, getItemLayout: (_data, index) => ({
