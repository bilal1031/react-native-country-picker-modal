...
const renderItem = (props) => ({ item: country }) => (React.createElement(CountryItem, { country, ...props }));
...
export const CountryList = ({ data, withAlphaFilter = false, withEmoji = true, withFlag = true, withCallingCode = false, withCurrency = false, onSelect, filter, flatListProps, filterFocus, }) => {
