...
const FlagText = (props) => (react_1.default.createElement(CountryText_1.CountryText, Object.assign({}, props, { style: styles.something })));
...
const FlagButton = ({ allowFontScaling, withEmoji = true, withCountryNameButton = false, withCallingCodeButton = false, withCurrencyButton = false, withFlagButton = true, countryCode, containerButtonStyle, onOpen, placeholder, }) => {
