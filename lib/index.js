...
const Main = (_a) => {
    var { theme, translation, onSelect = () => { }, withEmoji = true } = _a, props = __rest(_a, ["theme", "translation", "onSelect", "withEmoji"]);
    return (react_1.default.createElement(CountryTheme_1.ThemeProvider, { theme: Object.assign(Object.assign({}, CountryTheme_1.DEFAULT_THEME), theme) },
        react_1.default.createElement(CountryContext_1.CountryProvider, { value: Object.assign(Object.assign({}, CountryContext_1.DEFAULT_COUNTRY_CONTEXT), { translation }) },
            react_1.default.createElement(CountryPicker_1.CountryPicker, Object.assign({}, props, { onSelect: onSelect, withEmoji: withEmoji })))));
};
